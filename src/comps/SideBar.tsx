...
import { TransitionRoot, Dialog, DialogPanelProps, DialogProps, TransitionChild } from "@/lib/headlessui"
...
export const SideBar = ({ open, children, panelProps, direction = "right", ...props }: SideBarProps) => (
