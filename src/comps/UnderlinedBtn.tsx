...
export function UnderlinedBtn({ children, direction = "flex-row", hideArrow = false, ...props }: UnderlinedBtnProps) {
	return (
		<MotionLink
			{...props}
			className={twMerge(
				`group flex items-center gap-3 text-sm tracking-wider ${direction} select-none rounded-md py-3 pl-3 pr-1 text-black focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-1 focus-visible:outline-primary`,
				props?.className
			)}>
			<span
				className={twMerge(
