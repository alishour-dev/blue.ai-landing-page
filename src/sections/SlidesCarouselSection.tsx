...
import { Carousel, UnderlinedBtn } from "@/comps"
...
const MarkdownWrapper = dynamic(() => import("@/layouts").then((m) => m.MarkdownWrapper))
...
export const SlidesCarouselSection = ({ slides }: SlidesCarouselData) => {
	...
	return (
		<>
			<MotionCarousel
				...
				className='relative p-1 pb-0 [--slide-height:290px] [--slide-size:100%] [--slide-spacing:12px] md:p-0 md:[--slide-size:55%] md:[--slide-spacing:40px]'
				imgProps={{ width: 826, height: 290, className: "rounded-[28px]" }}
				{...slideUp}>
